...
public class Aplicacion {
    ...
    public static void vender(ArrayList<Libro> libros) {
    ...
    public static void darDeBaixa(ArrayList<Libro> libros) {
    ...
    public static void amosar(ArrayList<Libro> libros) {
    ...
    public static void consultar(ArrayList<Libro> libros) {
